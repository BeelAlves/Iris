...
#
# Projeto: Iris
# Faz a pós configuração do Ubuntu e derivados.
#
# Autor:         Gabriel Alves
#
# ------------------------------------------------------------------------ #
...
# Changelog:
#
#   v1.0 30/09/2022, Gabriel Alves:
#     - Primeira versão
#   v2.0 10/10/2022, Gabriel Alves;
#     - Versão com poucos aplicativos a serem instalados
#
# ------------------------------------------------------------------------ #
#
# -------------------------------VARIÁVEIS----------------------------------------- #
